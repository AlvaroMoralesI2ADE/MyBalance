...
function cargarDietaModelo(dieta) {
    try {
        ...
        query += "alimentos_comida_modelo.cantidad, comidas_dia_modelo.dia "
        query += "FROM comidas_dia_modelo, alimentos_comida_modelo "
        query += "WHERE comidas_dia_modelo.dieta_modelo = \"" + dieta + "\" AND comidas_dia_modelo.idcomidas_dia_modelo = "
                    ...
                    if (pos != -1) {
                        ...
                        if (comidas[pos].añadirAlimento((alimento + "-" + comida + "-" + dia), result[i].cantidad)) {
                            ...
                            if (data.clientWidth > 250) {
                                ...
                                document.getElementById("btn-" + comida.value + "-" + dia + "-" + (comidas[pos].btn_group_width + 1)).style.margin = "5px";
    ...
    try {
        ...
        if(comidas.length > 0){
           ...
           let nombreD =  nombreUsuario  + "/" + fechasArray[0]
            ...
            query += "INSERT INTO comidas_dia (dia, dieta) VALUES ('" + fechasArray[0] + "', \"" + nombreD + "\"); \n"
            query += "INSERT INTO comidas_dia (dia, dieta) VALUES ('" + fechasArray[1] + "', \"" + nombreD + "\"); \n"
            query += "INSERT INTO comidas_dia (dia, dieta)  VALUES ('" + fechasArray[2] + "', \"" + nombreD + "\"); \n"
            query += "INSERT INTO comidas_dia (dia, dieta)  VALUES ('" + fechasArray[3] + "', \"" + nombreD + "\"); \n"
            query += "INSERT INTO comidas_dia (dia, dieta)  VALUES ('" + fechasArray[4] + "', \"" + nombreD + "\"); \n"
            query += "INSERT INTO comidas_dia (dia, dieta)  VALUES ('" + fechasArray[5] + "', \"" + nombreD + "\"); \n"
            query += "INSERT INTO comidas_dia (dia, dieta)  VALUES ('" + fechasArray[6] + "', \"" + nombreD + "\"); \n"
