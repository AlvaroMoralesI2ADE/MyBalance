...
function renderSuscripcion(fecha_inicioS, fecha_finS, nombre, email, idsuscripcion, dietaAsignada, Novistos, AlimModificar) {
    try {
      ...
      if (dietaAsignada > 0) {
        ...
        tr.prepend("<td>" + "<a class=\"buttonTable\" href=\"adminAsignarDieta.html?gmail=" + email + "&semana=" + fechaInicioFormat + "&suscripcion=" + idsuscripcion + "&semanaF=" + fechaFinFormat  + "&semanaI=" +  fechaInicioFormat + "&num=1\">Asignar dieta</a>" + "</td>");
